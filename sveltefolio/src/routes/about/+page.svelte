<div>
    <div class="content-wrapper">
        <img id="headshot"  src="/reduced_cropped_grad_headshot.jpg" alt="Graduation Headshot"/>
    ...
    <div class="content-wrapper">
        ...
        <p class="paragraph-wrapper">
            Full stack and game development are my two largest interests in regards to computer sciences. My senior design project at Gonzaga required me to learn React, which has now prompted me to remake my website. Although I have remade it again in Svelte because Svelte is awesome. I'm a big fan of pixel art and absolutely love fishing games (all the best games have a fishing minigame), so I decided to have a little fun with the design. Read about how I've incorporated these into some of my other projects on my projects page. 
        </p>
    </div>
    <div class="content-wrapper">
